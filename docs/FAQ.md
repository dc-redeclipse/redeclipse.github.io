...
This is the development version of the game, which can be [obtained](Contributing#preliminaries) from our Github repository to check out upcoming features and life on the bleeding edge.
